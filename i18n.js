...
if (typeof window.PromptVaultI18n === 'undefined') {
  ...
  const translations = {
    zh: {
      ...
      settings_variables: '变量模板',
      settings_variables_desc: '用 {{变量}} 把提示词变成可复用的模板',
      btn_variable_guide: '使用教程',
      btn_variable_sample: '创建示例',
      btn_copy_short: '复制',
      btn_got_it: '知道了',
      variable_guide_title: '变量使用教程',
      variable_guide_intro: '变量让你的提示词变成可复用的模板：结构固定，只换几个词。',
      variable_guide_syntax_title: '语法',
      variable_guide_syntax_desc: '用两对花括号包住变量名，变量名可以是中文。',
      variable_guide_syntax_code: '{{变量名}}',
      variable_guide_example_code: '请帮我写一篇关于 {{主题}} 的文章。\n字数约 {{字数}} 字，\n语气要 {{语气}}。',
      variable_guide_example_title: '完整示例',
      variable_guide_steps_title: '使用步骤',
      variable_guide_step1: '新建提示词，在内容里写上 {{主题}} 这样的占位符',
      variable_guide_step2: '保存后，卡片上会出现「含变量」标签',
      variable_guide_step3: '点击复制或插入，会弹出填空框，填完自动替换',
    ...
    en: {
      ...
      settings_variables: 'Variable Templates',
      settings_variables_desc: 'Turn prompts into reusable templates with {{variables}}',
      btn_variable_guide: 'Guide',
      btn_variable_sample: 'Create Sample',
      btn_copy_short: 'Copy',
      btn_got_it: 'Got it',
      variable_guide_title: 'Variable Guide',
      variable_guide_intro: 'Variables turn your prompt into a reusable template: fixed structure, only a few words change.',
      variable_guide_syntax_title: 'Syntax',
      variable_guide_syntax_desc: 'Wrap the variable name in double curly braces. Names can be in any language.',
      variable_guide_syntax_code: '{{variable}}',
      variable_guide_example_code: 'Please write an article about {{topic}}.\nAround {{length}} words,\nwith a {{tone}} tone.',
      variable_guide_example_title: 'Full Example',
      variable_guide_steps_title: 'How to Use',
      variable_guide_step1: 'Create a prompt and write placeholders like {{topic}} in the content',
      variable_guide_step2: 'After saving, the card shows a "Variables" badge',
      variable_guide_step3: 'Click copy or insert — a dialog appears, values replace the placeholders',
      ...
      toast_sample_created: 'Sample prompt created',
